...
const CARD_WIDTH: number = 415;
const CARD_HEIGHT: number = 540;
const TITLE_HEIGHT: number = 132;

const CARD_MOBILE_WIDTH: number = 335;
const CARD_MOBILE_HEIGHT: number = 512;
const TITLE_MOBILE_HEIGHT: number = 132;
